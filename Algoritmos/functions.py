...
def EmotionFeminino(lista):
    ...
    if (lista[4] > -16.26 and lista[4] <= -1.11) and (lista[18] >= -14.07 and lista[18] < 0) and (lista[20] >= -10.03 and lista[20] <= 5.92):
        #print("raiva")
        #AU4, A24, AU26
        return  1
    
    if (lista[9] >= -21.18 and lista[9] <= -5.89) and (lista[10] >= -22.83 and lista[10] <= -5.16) and (lista[11] >= -8.97 and lista[11] <= -0.97) and (lista[19] >= 0 and lista[19] <= 17):
        #print("nojo")
        #AU10, AU25, AU9
        return  3
    ...
    if (lista[8] >= -14.03 and lista[8] < 0) and (lista[12] >= 11.09 and lista[12] < 44.97):
        #print("Alegria")
        #AU6, AU12
        return  5
