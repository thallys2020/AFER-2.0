# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 23:17:45 2021
...
def EmotionMasculino(lista):
    ...
    if (lista[0] >= 4.50 and lista[0] <= 8.60) and (lista[1] >= 3.94 and lista[1] <= 7.16) and (lista[13] >= 1.46 and lista[13] <= 23.24) and (lista[14] >= 0.37 and lista[14] <= 29.99) and (lista[15] >= -10.02 and lista[15] <= -1.99):
        #print("sadness")
        #A1, A15, A17
        return  6
    ...
    if (lista[9] >= -20.42 and lista[9] <= -7.82) and (lista[10] >= -19.3 and lista[10] <= -9.10) and (lista[11] >= -13.64 and lista[11] <= -0.05) and (lista[19] >= 0 and lista[19] <= 5.06):
        #print("nojo")
        #AU10, AU25, AU9
        return  3
    ...
    if (lista[8] >= -7.03 and lista[8] < -1.13) and (lista[12] >= 12.86 and lista[12] < 36.94):
        #print("Alegria")
        #AU6, AU12
        return  5

    if (lista[20] >= 21 and lista[20] <= 39.10) and (lista[5] >= 0.09 and lista[5] <= 9.02) and (lista[6] >= 0. and lista[6] <= 8.99):
        #print("surpresa")
        #AU26, AU5
        return  7
...
def EmotionFeminino(lista):
    ...
    if (lista[4] > -16.9 and lista[4] <= 0) and (lista[17] >= -20.13 and lista[17] < -0.23) and (lista[18] >= -18 and lista[18] < -1.90):
        #print("raiva")
        return  1
    
    if (lista[11] >= -3 and lista[11] <= -0.05) and (lista[15] >= -2.88 and lista[15] <= -0.9):
        #print("nojo")
        return  3
